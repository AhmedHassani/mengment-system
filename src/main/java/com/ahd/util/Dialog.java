...
import com.ahd.main.Controller.MainController;
...
class Dialog {
    ...
    private static void createLayout(VBox header, VBox content, HBox actions){
        ...
        VBox box = new VBox();
        box.setStyle("-fx-background-radius : 20 20 20 20; -fx-background-color : white;");
    ...
    private static VBox createHeader(Type type){
        ...
        switch (type){
            ...
            case SUCCESS:
                ...
                Image image =new Image(Dialog.class.getResource("/icon/done.png").toExternalForm());
    ...
    private static VBox  createContent(String title, String message){
        ...
        lblTitle.setStyle("-fx-font-size : 30px; -fx-text-fill :#858789;");
        Label text = new Label();
        text.setWrapText(true);
        text.setText(message);
        text.setMaxWidth(340);
        text.setAlignment(Pos.CENTER);
        text.setStyle("-fx-text-fill :#858789; ");
...
//                break;
    ...
    private static void show(Region region){
        dialog.setDialogContainer(MainController.getAppstack());
